...
Pleasant news: Now otp_kickoff also installs the gem ebuilder, a very simple tool for building Erlang/OTP projects. It is all about facilitate our life. For more informations about ebuilder, see: http://github.com/leandrosilva/ebuilder.
