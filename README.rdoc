...
Pleasant news: Now otp_kickoff also installs the gem ebuilder, a simple tool for building Erlang/OTP projects. For more informations about ebuilder, see: http://github.com/leandrosilva/ebuilder.
